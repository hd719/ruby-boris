...
def product_of_number_and_index
  sum = 0
...
puts product_of_number_and_index([1, 2, 3]) # 8
puts product_of_number_and_index([]) # 0
puts product_of_number_and_index([10, 20, 30]) # 110
puts product_of_number_and_index([5, 10, 15]) # 45
