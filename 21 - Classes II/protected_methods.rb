# public methods - can be invoked by any other object (instances)
#
# private methods - can only be invoked by internal methods
#
# protected methods - can only be invoked by internal methods in a class or
...
# puts civic.value # this wont work
